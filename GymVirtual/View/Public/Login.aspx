<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="GymVirtual.View.Public.Login" %>
                    ...
                    <ext:FormPanel runat="server" Width="490" Height="330" BodyPadding="10" Frame="true" UI="Info" DefaultAnchor="100%">
                        <Items>
                            <ext:Panel runat="server">
                                <Items>
                                    <ext:FieldSet runat="server" Title="Gym Cuerpos" Cls="titleLogin" BaseCls="titleLogin">
                                        <Items>
                                            ...
                                            <ext:Image runat="server" ImageUrl="../../Content/img/logo.png" Height="70" />
                                        </Items>
                                    </ext:FieldSet>
